...
class AppIntro : AppIntro() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addSlide(AppIntroFragment.newInstance("Plane Detection","To begin with, ARCore need to scan the environment to allow placing of virtual Furniture. Follow the animated hand until you see small dots!",R.drawable.scanpic,Color.BLACK,Color.WHITE,Color.WHITE))
        addSlide(AppIntroFragment.newInstance("Furniture Menu","Once the small dots are shown you then can pick any of the virtual furniture! Just tap on the button on the lower right corner of the screen.",R.drawable.menupic, Color.BLACK,Color.WHITE,Color.WHITE))
